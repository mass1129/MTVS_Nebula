...
Shader "SyntyStudios/GrungeTriplanar"
{
	Properties
	{
		...
		[ASEEnd]_Large_DirtAmount("Large_DirtAmount", Range( 0 , 1.2)) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar17 = TriplanarSampling17( _Mask, _Black, _Black, WorldPosition, WorldNormal, _Dust_FallOff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				...
				float4 triplanar16 = TriplanarSampling16( _Grunge, _Grunge, _Grunge, WorldPosition, WorldNormal, _Dirt_Falloff, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				...
				float4 triplanar27 = TriplanarSampling27( _Large_Grunge, _Large_Grunge, _Large_Grunge, WorldPosition, WorldNormal, _Large_FallOff, temp_cast_3, float3( 1,1,1 ), float3(0,0,0) );
				...
				float3 Albedo = ( lerpResult18 * lerpResult33 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar17 = TriplanarSampling17( _Mask, _Black, _Black, WorldPosition, ase_worldNormal, _Dust_FallOff, float2( 1,1 ), float3( 1,1,1 ), float3(0,0,0) );
				float clampResult22 = clamp( triplanar17.w , 0.0 , _Dust_Amount );
				float4 lerpResult18 = lerp( tex2D( _Texture, uv_Texture ) , _Dust_Colour , clampResult22);
				float2 temp_cast_0 = (_Dirt_Tiling).xx;
				float4 triplanar16 = TriplanarSampling16( _Grunge, _Grunge, _Grunge, WorldPosition, ase_worldNormal, _Dirt_Falloff, temp_cast_0, float3( 1,1,1 ), float3(0,0,0) );
				float4 temp_cast_1 = (_Dirt_Amount).xxxx;
				float4 clampResult7 = clamp( triplanar16 , temp_cast_1 , float4( 1,1,1,0 ) );
				float4 temp_cast_2 = 1;
				float2 temp_cast_3 = (_Large_Tiling).xx;
				float4 triplanar27 = TriplanarSampling27( _Large_Grunge, _Large_Grunge, _Large_Grunge, WorldPosition, ase_worldNormal, _Large_FallOff, temp_cast_3, float3( 1,1,1 ), float3(0,0,0) );
				float4 temp_cast_4 = (_Large_DirtAmount).xxxx;
				float4 clampResult31 = clamp( triplanar27 , temp_cast_4 , float4( 1,1,1,0 ) );
				float4 lerpResult33 = lerp( clampResult7 , temp_cast_2 , clampResult31);
...
/*ASEBEGIN
Version=18935
-2999.2;346.4;3058;845;3466.091;654.225;1.710568;True;True
...
WireConnection;36;3;24;0
WireConnection;36;4;25;0
ASEEND*/
//CHKSM=254F63C8600DD8762D91114BF0B983FEE02F34B3