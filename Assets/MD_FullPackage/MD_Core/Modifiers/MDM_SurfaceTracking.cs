...
namespace MD_Plugin
{
    ...
    /// Surface tracking for specific shader & material (requires Lite Mesh Tracker shader). Create tracks & footprints with a very quick & simple way
    /// </summary>
    [ExecuteInEditMode]
...
namespace MD_PluginEditor
{
    ...
    public class MDM_LandscapeTracking_Editor : MD_EditorUtilities
    {
        ...
        {
            ps();
            phb("Object must contains MD_LiteMeshTracker shader");
            ps();
