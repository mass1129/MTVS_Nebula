...
namespace MD_Plugin
{
    ...
    /// Lite version of the sculpting feature for mesh renderers in editor / at runtime. Visit https://assetstore.unity.com/packages/tools/modeling/sculpting-pro-201873 for pro version
    /// </summary>
    [ExecuteInEditMode]
    ...
    public class MDM_SculptingLite : MonoBehaviour
    {
        ...
        public bool SS_AlternateNormalsRecalculation = false;
        public float SS_AlternateNormalsRecalculationAngle = 90.0f;
        ...
        private void Awake()
        {
            ...
            SS_AlternateNormalsRecalculation = MD_GlobalPreferences.AlternateNormalsRecalc;
        ...
        public void SS_Funct_RestoreOriginal()
        {
            ...
            if (SS_AutoRecalculateNormals)
            {
                if (!SS_AlternateNormalsRecalculation)
                    meshFilter.sharedMesh.RecalculateNormals();
                else
                    MD_MeshMathUtilities.AlternativeNormalCalculation.RecalculateNormals(meshFilter.sharedMesh, SS_AlternateNormalsRecalculationAngle);
            }
