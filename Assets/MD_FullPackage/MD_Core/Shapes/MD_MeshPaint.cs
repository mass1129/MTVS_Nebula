...
namespace MD_Plugin
{
    ...
    /// Complete solution of simple mesh painting
    /// </summary>
    ...
    public class MD_MeshPaint : MonoBehaviour
    {
        ...
        //BRUSH & MESH SETTINGS
        public bool MP_UniformSize = true;
        public float MP_BrushSize = 0.5f;
        public Vector3 MP_BrushSizeXYZ = Vector3.one;
        ...
        private void Update()
        {
            ...
            if (MP_FollowBrushTransform)
            {
                ...
                else
                {
                    ...
                    MP_ObjectForFollowing.localScale = MP_UniformSize ? Vector3.one * MP_BrushSize : Vector3.one + MP_BrushSizeXYZ;
                }
            }
        }
        ...
        private void INTERNAL_ChangeBrushSize(Vector3 size)
        {
        ...
        public void PUBLIC_PaintMesh(Vector3 Position, MeshPaintModeInternal MeshPaintMode)
        {
            ...
            INTERNAL_ChangeBrushSize(MP_UniformSize ? Vector3.one * MP_BrushSize : MP_BrushSizeXYZ);
        ...
        {
            MP_BrushSize = size;
            MP_BrushSizeXYZ = Vector3.one * size;
        }
        ...
        public void PUBLIC_ChangeBrushSize(UnityEngine.UI.Slider size)
        {
            ...
            MP_BrushSizeXYZ = Vector3.one * size.value;
        }
