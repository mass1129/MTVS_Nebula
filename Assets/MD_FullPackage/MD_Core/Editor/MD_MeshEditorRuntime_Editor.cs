...
namespace MD_PluginEditor
{
    ...
    public class MD_MeshEditorRuntime_Editor : MD_EditorUtilities
    {
        public override void OnInspectorGUI()
        {
            ...
            pv();
            ppDrawProperty("ppMainCam", "Main Camera", "Assign main camera in the scene that will represent 'Origin'. Leave this field empty if the camera (tagged as MainCamera) exists in the scene");
            pve();
